package cn.edu.sysu.workflow.enginefeign.service.impl;
...
import cn.edu.sysu.workflow.enginefeign.service.ApplicationPerformanceMonitorService;
...
public class ApplicationPerformanceMonitorServiceImpl implements ApplicationPerformanceMonitorService {
    ...
    public void postConstruct() {
        try {
            ...
            serviceInfo.setServiceInfoId(BooEngineFeignApplication.ENGINE_FEIGN_ID);
    ...
    public void preDestroy() {
        try {
            serviceInfoDAO.deleteByServiceInfoId(BooEngineFeignApplication.ENGINE_FEIGN_ID);
        } catch (Exception e) {

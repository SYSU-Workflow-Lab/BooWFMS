...
public class Process extends BooPagedQuery {
    ...
    public boolean equals(Object o) {
        ...
        return launchCount == process.launchCount &&
                ...
                Objects.equals(createTimestamp, process.createTimestamp) &&
                Objects.equals(lastLaunchTimestamp, process.lastLaunchTimestamp);
    }

    @Override
    public int hashCode() {
        return Objects.hash(processId, processName, mainBusinessObjectId, creatorId, launchCount, successCount, averageCost, status, createTimestamp, lastLaunchTimestamp);
    }
}

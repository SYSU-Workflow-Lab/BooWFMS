...
public class SCXMLSemanticsImpl implements BOXMLSemantics {
     ...
     * log
     */
    private static final Logger log = LoggerFactory.getLogger(SCXMLSemanticsImpl.class);
    ...
    public void finalStep(BOXMLExecutionContext exctx) throws ModelException {
        ...
        for (EnterableState es : configuration) {
            ...
            try {
                ...
                log.error("[" + exctx.processInstanceId + "]When clear finish tree and send finish ProcessInstanceId " +
                        "to resource service, exception occurred, " + e.toString());
            }
        }
    }

 ...
 */
public class BooRoleMap extends BooPagedQuery {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mapId, runtimeRecordId, broleName, corganGid, mappedGid, dataVersion);
    }
}
